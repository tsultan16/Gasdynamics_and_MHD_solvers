...
!Local Variables
real::q(-3:nx+4),qint_plus(0:nx),qint_minus(0:nx)
real::a1,b1,c1,d1
real::a2,b2,c2,d2
integer::i
...
do i=0,nx
  ...
  !q_i+1/2
  qint_plus(i)=(1./12.)*(-q(i-1)+7.*q(i)+7.*q(i+1)-q(i+2))-phi(a1,b1,c1,d1)
  qint_minus(i)=(1./12.)*(-q(i-1)+7.*q(i)+7.*q(i+1)-q(i+2))+phi(a2,b2,c2,d2)
end do

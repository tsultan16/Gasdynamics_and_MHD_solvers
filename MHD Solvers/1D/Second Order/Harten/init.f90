...
!Initialize Harten's Artificial Viscosity Parameter
!NOTE: Varying amounts of artificial viscosity added to each wave mode
!Artificial viscosity suppresses unphysical expansion shock formation (it's an "entropy fix")  
del(1)=0.2
del(2)=0.4
del(3)=0.2
del(4)=0.0 

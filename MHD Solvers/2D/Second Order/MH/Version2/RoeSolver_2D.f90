...
if(debug==1)then
  ...
  print*,'Interp. RP Left State (rho,u,v,w,bx,by,bz,p) =',rhoL,uL,vL,wL,bxL,byL,bzL,pL
  print*,'Interp. RP Right State (rho,u,v,w,bx,by,bz,p) =',rhoR,uR,vR,wR,bxR,byR,bzR,pR
end if

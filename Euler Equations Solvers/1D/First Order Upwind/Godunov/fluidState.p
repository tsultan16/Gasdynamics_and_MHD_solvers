...
do for [i=0:tSteps-1] {
  ...
  plot "ouput_euler_godunov.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with lines notitle
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  set yrange [-5:305]
  plot "ouput_euler_godunov.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with lines notitle
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "ouput_euler_godunov.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with lines notitle
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

program EulerGodunov
use RiemannExact_mod
implicit none
...
!Note: Indices -1,0,nx+1,nx+2 represent guard cells for enforcing periodic boundary conditions 
real*8::fL(3),fR(3)
real*8::xmin,xmax,cour,x,gamil,pressure
integer::i,j,k

open(unit=10,file='input.txt')
open(unit=11,file='output_euler_godunov.txt')
...
!compute solution
do i=1,tSteps-1
  print*,'Percent Complete =',i*100./tSteps*1.
  do j=1,nx
    x=xmin+j*dx

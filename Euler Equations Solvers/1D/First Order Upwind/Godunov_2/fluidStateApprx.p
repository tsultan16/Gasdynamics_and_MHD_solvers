...
set output 'GodunovFluidState_Apprx.gif'
...
do for [i=0:tSteps-1] {
  ...
  plot "output_Godunov_appr.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with linespoint pointtype 7 lc rgb "blue" notitle
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  set ylabel "Velocity"
  #set yrange [-5:305]
  plot "output_Godunov_appr.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with linespoint pointtype 7 lc rgb "blue" notitle 
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "output_Godunov_appr.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with linespoint pointtype 7 lc rgb "blue" notitle
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

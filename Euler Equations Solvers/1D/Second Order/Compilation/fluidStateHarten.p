...
do for [i=0:tSteps-1] {
  ...
  "output_EulerENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with lines lc rgb "green" title "ENO"
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  "output_EulerENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with lines lc rgb "green" title "ENO"
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  "output_EulerENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with lines lc rgb "green" title "ENO"
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

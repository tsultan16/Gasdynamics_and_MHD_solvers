...
do for [i=0:tSteps-1] {
  ...
  plot "output_euler_ENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with linespoint pointtype 6 lc rgb "blue"
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  #set yrange [-5:305]
  plot "output_euler_ENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with linespoint pointtype 6 lc rgb "blue" 
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "output_euler_ENO.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with linespoint pointtype 6 lc rgb "blue"
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

...
do for [i=0:tSteps-1] {
  ...
  plot "output_euler_harten_FC.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with lines lc rgb "blue" title "TVD" 
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  #set yrange [-5:305]
  plot "output_euler_harten_FC.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with lines lc rgb "blue" title "TVD" 
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "output_euler_harten_FC.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with lines lc rgb "blue" title "TVD"
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

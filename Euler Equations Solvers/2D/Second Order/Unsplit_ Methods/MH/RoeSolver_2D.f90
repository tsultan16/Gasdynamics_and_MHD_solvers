...
integer,parameter::fluidInit=2 !1:V Shock, 2:Oblique Riemann Problem, 3:Riemann Problem File input 4:Kelvin-Helmholtz Instability 
...
print*,'pS,pmin,pmax=',pS,pMin,pMax

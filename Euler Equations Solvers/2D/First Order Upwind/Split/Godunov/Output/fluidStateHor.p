...
set output 'GodunovFluidState_y=0.5.gif'
...
do for [i=0:tSteps-1] {
  ...
  plot "horcut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with linespoint pointtype 7 lc rgb "blue" title "Godunov" 
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  set ylabel "Velocity"
  #set yrange [-5:305]
  plot "horcut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:3 with linespoint pointtype 7 lc rgb "blue" title "Godunov"
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "horcut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:5 with linespoint pointtype 7 lc rgb "blue" title "Godunov"
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

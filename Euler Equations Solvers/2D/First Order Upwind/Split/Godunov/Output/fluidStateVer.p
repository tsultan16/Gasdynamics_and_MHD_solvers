...
do for [i=0:tSteps-1] {
  ...
  plot "vercut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:2 with linespoint pointtype 7 lc rgb "blue" title "Godunov" 
  unset title
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  #set yrange [-5:305]
  plot "vercut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:4 with linespoint pointtype 7 lc rgb "blue" title "Godunov"
  #unset xlabel
  unset ylabel
  unset yrange
  ...
  plot "vercut.txt" every ::i*nx+1::nx+(i*nx)-1 using 1:5 with linespoint pointtype 7 lc rgb "blue" title "Godunov"
  unset xlabel
  unset ylabel
  unset yrange
  unset multiplot

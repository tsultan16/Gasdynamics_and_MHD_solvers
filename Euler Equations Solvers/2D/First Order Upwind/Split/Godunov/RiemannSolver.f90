...
real*8::rhoSL,rhoSR,uS,vS,pS,aSL,aSR,fR !star region state
...
yflux(jj,1)=w1*w2
yflux(jj,2)=w1*w2*w3
yflux(jj,3)=w1*w2*w2+w4
yflux(jj,4)=0.5*w1*(w2*w2+w3*w3)*w2+gam*gamul*w2*w4
end if
